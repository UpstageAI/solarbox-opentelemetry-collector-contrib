...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/sqlquery v0.148.0
...
require (
	...
	go.opentelemetry.io/collector/extension/xextension v0.148.1-0.20260320051400-372cc483b303
